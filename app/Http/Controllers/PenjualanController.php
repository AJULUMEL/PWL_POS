...
class PenjualanController extends Controller
{
    ...
    {
        $penjualan = PenjualanModel::with(['user', 'penjualan_detail'])
        ...
        ->addColumn('total_harga', function ($penjualan) {
            return 'Rp ' . number_format($penjualan->penjualan_detail->sum(function ($detail) {
    ...
    public function store_ajax(Request $request)
{
    ...
    public function show_ajax(string $id)
    {
        ...
        $penjualan->total_bayar = $penjualan->penjualan_detail->sum(fn($d) => $d->harga * $d->jumlah);
    ...
    public function import_ajax(Request $request)
{
    ...
    {
        $penjualan = PenjualanModel::with('penjualan_detail', 'user')->withSum('penjualan_detail', 'harga')
            ->orderBy('penjualan_tanggal')
            ->get();
