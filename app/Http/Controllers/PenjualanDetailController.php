...
class PenjualanDetailController extends Controller
{
    ...
    {
    if ($request->ajax()) {
        $penjualanDetail = DetailPenjualanModel::with(['penjualan', 'barang']);
...
{
    $details = DetailPenjualanModel::with(['penjualan', 'barang'])->get();
...
{
    $data = DetailPenjualanModel::with(['penjualan', 'barang'])->get();
