    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="card-tools">
                <button onclick="modalAction('{{ route('profile.editPfp') }}')" class="btn btn-primary">Edit Foto
                    Profil</button>
        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-3 text-center">
                    <img src="{{ auth()->check() ? auth()->user()->getProfilePictureUrl() : asset('avatar.png') }}" alt="User Image" width="100"
